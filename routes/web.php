...
// Route::middleware(['auth', 'role:user'])->group(function () {
    ...
    Route::get('/attempt/{attempt}/question/{questionNumber}', [QuizAttemptController::class, 'showQuestion'])->name('user.attempt.start'); // show a specific question in the quiz attempt
