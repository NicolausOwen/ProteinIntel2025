    ...
    <section class="relative min-h-screen bg-transparent flex items-center justify-center overflow-x-hidden">
        ...
        <div class="relative z-10 text-center px-4 max-w-6xl mx-auto">
            ...
            <div class="bg-gray-800/80 backdrop-blur-sm border border-gray-600 inline-flex items-center space-x-6 rounded-full px-8 py-4">
                <!-- TikTok -->
                <a href="https://www.tiktok.com/@intelunsri" class="text-gray-200 hover:text-white transition-colors duration-300 flex items-center">
                ...
                <!-- Instagram -->
                <a href="https://www.instagram.com/intelunsri" class="text-gray-200 hover:text-white transition-colors duration-300 flex items-center">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- YouTube -->
                <a href="https://www.youtube.com/channel/UCWuslv4zMt-y33dRd7a_2dg" class="text-gray-200 hover:text-white transition-colors duration-300 flex items-center">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- LinkedIn -->
                <a href="https://www.linkedin.com/company/intelunsri/?originalSubdomain=id" class="text-gray-200 hover:text-white transition-colors duration-300 flex items-center">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
