...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white">
        ...
        <section class="relative bg-cover bg-center bg-no-repeat lg:h-[70vh] md:h-[50vh] h-[30vh] max-h-[800px]" style="background-image: url('{{ asset('img/home/banner.png') }}');">
            ...
            <div class="p-6 relative flex flex-col-reverse lg:flex-row overflow-hidden h-auto bg-gradient-to-r from-[#7F8CAA] to-[#B8CFCE] lg:h-[350px]">
                ...
                <div class="w-full gap-2 relative flex flex-col lg:flex-row items-center px-6 lg:px-10">
                    ...
                    <div class="w-[80%] md:w-[60%] h-[95%] lg:ml-[-100px] flex justify-center lg:mx-6 mb-4 lg:mb-0">
                        <img src="{{ asset('img/home/gambar.jpg') }}" alt="gambar" class="rounded-[200px] w-full max-w-lg h-auto object-cover shadow-2xl hover:shadow-3xl transition-all duration-500">
                    </div>

                    <div class="w-full lg:w-[40%] text-center lg:mr-auto">
                        <h1 class="text-2xl lg:text-3xl font-extrabold mb-4 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-900 bg-clip-text text-transparent text-justify drop-shadow-sm">
                            GETTING STARTED TO PROTEIN 2025
                        </h1>
                        <p class="text-sm lg:text-base mb-8 text-slate-800 text-justify leading-relaxed font-medium">
                            Unlock boundless opportunities with <strong class="bg-gradient-to-r from-slate-700 to-slate-900 bg-clip-text text-transparent font-bold">PROTEIN!</strong> Develop your English skills, Ace the USEPT, and Step further into a bright future.
                        </p>
                        <div class="flex justify-center lg:justify-start">
                            <button class="bg-gradient-to-r from-[#585a7d] to-[#333446] text-white font-semibold py-3 px-8 rounded-full shadow-2xl hover:shadow-3xl hover:from-[#333446] hover:to-[#585a7d] transition-all duration-300 transform hover:scale-105 backdrop-blur-sm border border-white/10">
                                START NOW
                            </button>
                        </div>
                    </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-6">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <!-- Feature 1 -->
                    <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                        <div class="w-16 h-16 bg-gradient-to-br from-teal-400 to-slate-500 rounded-full flex items-center justify-center mb-6 mx-auto">
                    ...
                    <!-- Feature 2 -->
                    <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                        <div class="w-16 h-16 bg-gradient-to-br from-slate-400 to-teal-500 rounded-full flex items-center justify-center mb-6 mx-auto">
                            <span class="text-white text-2xl">⚡</span>
                        </div>
                        <h3 class="text-xl font-semibold mb-4 text-center text-gray-800">
                            Skill Enhancement
                    ...
                    <!-- Feature 3 -->
                    <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                        <div class="w-16 h-16 bg-gradient-to-br from-teal-500 to-slate-400 rounded-full flex items-center justify-center mb-6 mx-auto">
                            <span class="text-white text-2xl">🎯</span>
                        </div>
                        <h3 class="text-xl font-semibold mb-4 text-center text-gray-800">
