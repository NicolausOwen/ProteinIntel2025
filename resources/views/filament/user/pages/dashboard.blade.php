        ...
        <x-filament::section>
            <x-slot name="heading">
                <div class="flex items-center gap-3">
                    <div class="flex items-center justify-center w-12 h-12 rounded-xl bg-primary-100 dark:bg-primary-900">
            ...
            <div class="space-y-6">
                <p class="text-gray-600 dark:text-gray-300">
                    Pantau progres belajarmu, lihat pencapaian terbaikmu, dan terus kembangkan kemampuanmu melalui dashboard ini
                </p>
                        ...
                        <div class="flex items-center justify-between w-full">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Perkembangan skor dari waktu ke waktu</p>
                                </div>
                            </div>
        ...
        <x-filament::section class="mt-6 mb-6"> 
            <x-slot name="heading">
                <div class="flex items-center justify-between flex-wrap gap-4 w-full mt-6">
                    <div class="flex items-center gap-3">
                        <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-warning-100 dark:bg-warning-900">
