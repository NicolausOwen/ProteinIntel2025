...
<!-- Quiz Introduction -->
    <section class="bg-[#EAEFEF]">
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-12 md:px-20 py-20 min-h-screen flex flex-col-reverse md:flex-row items-center justify-between gap-8">
            ...
            <div class="flex-1 max-w-xl space-y-6">
                <div class="space-y-4">
                    ...
                    <p class="text-base sm:text-lg text-[#7F8CAA] leading-relaxed">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nobis numquam aliquid rerum vel officia iusto maiores nisi hic ex laborum!
                    </p>
                </div>
                    ...
                    <div x-show="!expired" x-cloak class="w-full max-w-md">
                        ...
                        <div class="flex items-center justify-start gap-3 sm:gap-4">
                            <template x-for="unit in timerUnits" :key="unit.label">
                                <div class="rounded-xl shadow-[0_0_30px_rgba(184,207,206,0.3)] p-3 sm:p-4 text-center flex-1 transition-transform duration-300 hover:scale-105 backdrop-blur-md border border-white/20 bg-white/25">
            ...
            <div class="flex justify-center items-center px-8 mt-6 sm:mt-0">
                <img src="{{ asset('assets/illustration2.png') }}" alt="Quiz Illustration" class="w-full max-w-xs sm:max-w-md rounded-2xl drop-shadow-md transition-transform duration-300 ease-in-out hover:scale-105 hover:drop-shadow-xl">
            </div>
    ...
    <section class="bg-[#EAEFEF]" id="quiz-selection">
        ...
        <div class="min-h-screen flex items-center justify-center py-20 px-6 sm:px-12">
            ...
            quizCategories: [
                {
                    ...
                    questions: '35',
                    time: '40',
                    img: '{{ asset('assets/Listening.svg') }}'
                ...
                },
                {
                    ...
                    questions: '25',
                    time: '20',
                    img: '{{ asset('assets/Structure.svg') }}'
                },
                {
                    id: 'reading',
                    title: 'Reading',
            ...
            get activeCategory() {
                ...
                <div class="p-6 md:p-8 border-3 border-[#B8CFCE] rounded-lg shadow-md " x-show="activeCategory" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0">
                    <div class="flex flex-col lg:flex-row items-center gap-8">

                        <div class="flex-shrink-0 p-4">
                            <div class="w-32 h-32 md:w-40 md:h-40 flex items-center justify-center">
                                <img :src="activeCategory.img" :alt="activeCategory.title + ' icon'" class="max-w-full max-h-full object-contain">
                            </div>
                        </div>

                        <div class="flex-1 text-center lg:text-left">
                            <h2 class="text-2xl md:text-3xl font-bold text-[#333446] mb-4" x-text="activeCategory.title + ' Quiz'"></h2>
                            <p class="text-[#7F8CAA] text-base md:text-lg leading-relaxed mb-4" x-text="activeCategory.description"></p>
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 mb-8 text-sm md:text-base">
                                <div class="flex items-center justify-center lg:justify-start gap-2">
                                    ...
                                    <span class="text-[#7F8CAA]"><span x-text="activeCategory.questions"></span> Questions</span>
                                </div>
                                <div class="flex items-center justify-center lg:justify-start gap-2">
                                    <span class="w-2 h-2 bg-[#B8CFCE] rounded-full font-bold"></span>
                                    <span class="text-[#7F8CAA] "><span x-text="activeCategory.time"></span> Minutes</span>
                                </div>
                            </div>

                            <a :href="'{{url('quiz')}}/' + activeCategory.id" class="inline-block bg-[#333446] text-[#B8CFCE] hover:bg-[#EAEFEF] hover:text-[#333446] focus:ring-4 focus:outline-none focus:ring-[#B8CFCE] font-medium rounded-lg text-lg px-8 py-4 text-center transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg">
                                Start Quiz
                            </a>
                        </div>
                    </div>
