        ...
        <div class="w-full max-w-3xl space-y-8">
            ...
            <div id="confirmationModal"
                ...
                <div class="bg-white rounded-xl shadow-lg w-full max-w-md p-6">
                    ...
                    <p class="text-sm text-gray-600 mb-6">Apakah Anda yakin ingin menyelesaikan quiz ini? Jawaban yang sudah
                        dikirim tidak bisa diubah.</p>
                    <div class="flex justify-end space-x-3">
                        ...
                        <form id="finishForm" action="{{ route('user.attempt.submit', ['attempt' => $attempt->id]) }}"
                            method="POST" onsubmit="clearQuizStorage()">
                            @csrf
                            <button type="submit"
                                class="px-4 py-2 text-sm text-white bg-red-500 rounded hover:bg-red-600">Ya, Saya
                                Yakin</button>
                        </form>
                    </div>
                </div>
