...
@section('container')
    <div class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-4">
        <div class="w-full max-w-xl">
            <!-- Quiz Card -->
            <div
                class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-500">
                <!-- Header with Gradient -->
                <div
                    class="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-6 py-8 text-center relative overflow-hidden">
                    <!-- Background Pattern -->
                    <div class="absolute inset-0 opacity-10">
                        <div
                            class="absolute top-0 left-0 w-32 h-32 border border-white rounded-full -translate-x-16 -translate-y-16">
                        </div>
                        <div
                            class="absolute bottom-0 right-0 w-24 h-24 border border-white rounded-full translate-x-12 translate-y-12">
                        </div>
                        <div
                            class="absolute top-1/2 left-1/2 w-16 h-16 border border-white rounded-full -translate-x-8 -translate-y-8">
                        </div>
                    </div>
                    ...
                    {{-- <div class="relative z-10 mb-4">
                        <div
                            class="w-16 h-16 mx-auto bg-white bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
                ...
                <div class="px-6 py-6">
                    ...
                    <div class="text-center">
                        @if(isset($attempt) && $attempt->status !== 'completed')
                            {{-- Kalau sudah ada attempt & belum submit --}}
                            <a href="{{ route('user.quiz.sections', $attempt->id) }}"
            ...
            <div class="mt-6 grid grid-cols-3 gap-3">
                <div
                    class="bg-white bg-opacity-60 backdrop-blur-sm rounded-lg p-3 text-center border border-white border-opacity-20">
